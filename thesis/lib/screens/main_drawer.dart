    ...
    return Drawer(
        child: Column(
          children: <Widget>[
            ...
            ListTile(
              leading: AuthService.userIsAuthorized ? Icon(Icons.perm_identity) : Icon(Icons.login),
              title: Text(AuthService.userIsAuthorized ? "Moje konto" : "Logowanie", style: TextStyle(fontSize: 18)),
              onTap: () {
            ...
            ListTile(
              leading: AuthService.userIsAuthorized ? Icon(Icons.logout) : Icon(Icons.add),
              title: Text(AuthService.userIsAuthorized ? "Wyloguj" : "Rejestracja", style: TextStyle(fontSize: 18)),
              onTap: () {
                if(AuthService.userIsAuthorized){
                  _authService.logOut();
                  setState(() {});
